...
interface GitHubService {
    ...
    fun getFollowers(@Path ("username") username: String) : LiveData<ApiResponse<List<User>>>

    @GET("users/{username}/following")
    fun getFollowing(@Path ("username") username: String) : LiveData<ApiResponse<List<User>>>
